...
def calc_fbeta(mask, mask_pred):
    ...
    print(f"auc:, {roc_auc_score(mask, mask_pred)}")
    for th in np.array(range(10, 100+1, 10)) / 100:
    ...
    # print(f'best_th: {best_th}, fbeta: {best_dice}, precision: {best_precision}, recall: {best_recall}')
